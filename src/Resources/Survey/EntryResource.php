...
use Sharenjoy\NoahCms\Enums\SurveyEntryStatus;
use Sharenjoy\NoahCms\Infolists\Components\SurveyEntry;
use Sharenjoy\NoahCms\Models\Survey\Entry;
use Sharenjoy\NoahCms\Resources\Survey\EntryResource\Pages;
use Sharenjoy\NoahCms\Resources\Survey\EntryResource\RelationManagers\StatusesRelationManager;
...
class EntryResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return __('noah-cms::noah-cms.survey.navigation.entry.label');
    }

    public static function getPluralLabel(): string
    {
        return __('noah-cms::noah-cms.survey.navigation.entry.plural-label');
    }
    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                Section::make(__('noah-cms::noah-cms.survey.title.survey'))
                    ->schema([
                        SurveyEntry::make(''),
                    ])
                    ->collapsible()
