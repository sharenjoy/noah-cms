...
use Sharenjoy\NoahCms\Infolists\Components\SurveyAnswerEntry;
use Sharenjoy\NoahCms\Models\Survey\Answer;
use Sharenjoy\NoahCms\Resources\Survey\AnswerResource\Pages;
...
class AnswerResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return __('noah-cms::noah-cms.survey.navigation.answer.label');
    }

    public static function getPluralLabel(): string
    {
        return __('noah-cms::noah-cms.survey.navigation.answer.plural-label');
    }
    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                Section::make(__('noah-cms::noah-cms.survey.title.answer'))
                    ->schema([
