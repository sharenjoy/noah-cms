                ...
                Section::make('折扣碼設定')
                    ->schema([
                        TextInput::make('discount_percent')
                            ...
                            ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.userlevel_discount_percent')))
                        ...
                        TextInput::make('point_times')
                            ->label(__('noah-cms::noah-cms.shop.promo.title.point_times'))
                            ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.point_times')))
                        ...
                        TextInput::make('level_up_amount')
                            ->label(__('noah-cms::noah-cms.shop.promo.title.level_up_amount'))
                            ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.level_up_amount')))
                        ...
                        Radio::make('auto_level_up')
                            ->label(__('noah-cms::noah-cms.shop.promo.title.auto_level_up'))
                            ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.auto_level_up')))
                            ->options([
                        ...
                        Radio::make('forever')
                            ...
                            ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.userlevel_forever')))
                            ->options([
                                true => __('noah-cms::noah-cms.yes'),
                                false => __('noah-cms::noah-cms.no'),
                            ])
                        ...
                        Select::make('level_duration')
                            ->label(__('noah-cms::noah-cms.shop.promo.title.level_duration'))
                            ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.level_duration')))
                            ->options([
                                1 => '1年',
                                2 => '2年',
                                3 => '3年',
