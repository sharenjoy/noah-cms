        ...
        return [
            Section::make('折扣碼設定')
                ->schema([
                    ...
                    TextInput::make('code')
                        ->label(__('noah-cms::noah-cms.shop.promo.title.code'))
                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.code')))
                    ...
                    TextInput::make('usage_limit')
                        ->label(__('noah-cms::noah-cms.shop.promo.title.usage_limit'))
                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.usage_limit')))
                    ...
                    TextInput::make('per_user_limit')
                        ->label(__('noah-cms::noah-cms.shop.promo.title.per_user_limit'))
                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.per_user_limit')))
                        ->prefixIcon('heroicon-o-arrow-trending-up')
                        ->suffix('次')
                        ->placeholder(3)
                        ->minValue(1)
                    ...
                    Radio::make('auto_assign_to_user')
                        ->label(__('noah-cms::noah-cms.shop.promo.title.auto_assign_to_user'))
                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.auto_assign_to_user')))
                        ->options([
            ...
            Section::make('折扣碼事件設定')
                ...
                ->schema([
                    Select::make('auto_generate_type')
                        ...
                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.auto_generate_type')))
                        ->options(PromoAutoGenerateType::class)
                        ->default(PromoAutoGenerateType::Never->value)
                        ->required()
                        ->live(),
                    DatePicker::make('auto_generate_date')
                        ->label(__('noah-cms::noah-cms.shop.promo.title.auto_generate_date'))
                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.auto_generate_date')))
                    ...
                    Select::make('auto_generate_day')
                        ->label('日期')
                        ->label(__('noah-cms::noah-cms.shop.promo.title.auto_generate_day'))
                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.auto_generate_day')))
