        ...
        return $form
            ...
            ->schema(array_merge(\Sharenjoy\NoahCms\Utils\Form::make(static::getModel(), $form->getOperation()), [
                ...
                Section::make('目標商品設定')
                    ...
                    ->schema([
                        Radio::make('product.all')
                            ->label(__('noah-cms::noah-cms.shop.promo.title.all_products'))
                            ->options([
                        ...
                        Fieldset::make('add_products')
                            ->columns(1)
                            ->label(__('noah-cms::noah-cms.shop.promo.title.add_products'))
                            ->visible(fn(Get $get): bool => !$get('product.all'))
                            ->schema([
                                Select::make('product.add.categories')
                                    ->label(__('noah-cms::noah-cms.shop.promo.title.product_category'))
                                    ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.product_category')))
                                    ->preload()
                                ...
                                Select::make('product.add.tags')
                                    ->label(__('noah-cms::noah-cms.shop.promo.title.product_tag'))
                                    ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.product_tag')))
                                    ->preload()
                        ...
                        Fieldset::make('remove_products')
                            ->columns(1)
                            ->label(__('noah-cms::noah-cms.shop.promo.title.remove_products'))
                            ->schema([
                ...
                Section::make('目標使用者設定')
                    ...
                    ->schema([
                        Radio::make('user.all')
                            ->label(__('noah-cms::noah-cms.shop.promo.title.all_users'))
                            ->options([
                                true => __('noah-cms::noah-cms.yes'),
                                false => __('noah-cms::noah-cms.no'),
                            ])
