                    ...
                    Section::make('促銷規則設定')
                        ->schema([
                            TextInput::make('min_order_amount')
                                ->label(__('noah-cms::noah-cms.shop.promo.title.min_order_amount'))
                                ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.min_order_amount')))
                            ...
                            Fieldset::make('level')
                                ->columns(1)
                                ->label(__('noah-cms::noah-cms.shop.promo.title.level'))
                                ->schema([
                                    Radio::make('combined')
                                        ->label(__('noah-cms::noah-cms.shop.promo.title.combined'))
                                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.combined')))
                                        ->options([
                                    ...
                                    Select::make('promo_tags')
                                        ->label(__('noah-cms::noah-cms.shop.promo.title.promo_tag'))
                                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.promo_tag')))
                                        ->preload()
                            ...
                            Fieldset::make('duration')
                                ->columns(1)
                                ->label(__('noah-cms::noah-cms.shop.promo.title.duration'))
                                ->schema([
                                    Radio::make('forever')
                                        ->label(__('noah-cms::noah-cms.shop.promo.title.forever'))
                                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.forever')))
                                        ->options([
                                            true => __('noah-cms::noah-cms.yes'),
                                            false => __('noah-cms::noah-cms.no'),
                                        ])
                                    ...
                                    DateTimePicker::make('started_at')
                                        ...
                                        ->label(__('noah-cms::noah-cms.shop.promo.title.started_at'))
                                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.started_at')))
                                    ...
                                    DateTimePicker::make('expired_at')
                                        ->displayFormat('Y-m-d H:i:s') // 顯示格式
                                        ->label(__('noah-cms::noah-cms.shop.promo.title.expired_at'))
                                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.expired_at')))
                                        ->placeholder('2020-03-18 09:48:00')
                                        ->prefixIcon('heroicon-o-clock')
                                        ->format('Y-m-d H:i:s')
                                        ->required()
                            ...
                            Fieldset::make('discount_set')
                                ->columns(1)
                                ->label(__('noah-cms::noah-cms.shop.promo.title.discount_set'))
                                ->schema([
                                    Select::make('discount_type')
                                        ->label(__('noah-cms::noah-cms.shop.promo.title.discount_type'))
                                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.discount_type')))
                                        ->options(PromoDiscountType::class)
                                        ->required()
                                        ->live(),
                                    TextInput::make('discount_amount')
                                        ->label(__('noah-cms::noah-cms.shop.promo.title.discount_amount'))
                                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.discount_amount')))
                                        ->prefixIcon('heroicon-o-currency-dollar')
                                        ->placeholder(1200)
                                        ->numeric()
                                        ->minValue(0)
                                    ...
                                    TextInput::make('discount_percent')
                                        ->label(__('noah-cms::noah-cms.shop.promo.title.discount_percent'))
                                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.discount_percent')))
                                    ...
                                    TextInput::make('discount_percent_limit_amount')
                                        ->label(__('noah-cms::noah-cms.shop.promo.title.discount_percent_limit_amount'))
                                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.discount_percent_limit_amount')))
                                        ->prefixIcon('heroicon-o-currency-dollar')
                                        ->placeholder(200)
                                        ->numeric()
                                        ->minValue(0)
                    ...
                    Section::make('目標商品設定')
                        ->schema([
                            Select::make('productObjectives')
                                ->label(__('noah-cms::noah-cms.shop.promo.title.objective_product'))
                                ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.objective_product')))
                    ...
                    Section::make('目標使用者設定')
                        ->schema([
                            Select::make('userObjectives')
                                ->label(__('noah-cms::noah-cms.shop.promo.title.objective_user'))
                                ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.objective_user')))
