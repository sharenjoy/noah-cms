...
class PostPolicy
{
     ...
     */
    public function view(User|\Sharenjoy\NoahShop\Models\User $user, Post $post): bool
    {
     ...
     */
    public function update(User|\Sharenjoy\NoahShop\Models\User $user, Post $post): bool
    {
     ...
     */
    public function delete(User|\Sharenjoy\NoahShop\Models\User $user, Post $post): bool
    {
     ...
     */
    public function forceDelete(User|\Sharenjoy\NoahShop\Models\User $user, Post $post): bool
    {
     ...
     */
    public function restore(User|\Sharenjoy\NoahShop\Models\User $user, Post $post): bool
    {
     ...
     */
    public function replicate(User|\Sharenjoy\NoahShop\Models\User $user, Post $post): bool
    {
