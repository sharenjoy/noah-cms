...
class CarouselPolicy
{
     ...
     */
    public function view(User|\Sharenjoy\NoahShop\Models\User $user, Carousel $carousel): bool
    {
     ...
     */
    public function update(User|\Sharenjoy\NoahShop\Models\User $user, Carousel $carousel): bool
    {
     ...
     */
    public function delete(User|\Sharenjoy\NoahShop\Models\User $user, Carousel $carousel): bool
    {
     ...
     */
    public function forceDelete(User|\Sharenjoy\NoahShop\Models\User $user, Carousel $carousel): bool
    {
     ...
     */
    public function restore(User|\Sharenjoy\NoahShop\Models\User $user, Carousel $carousel): bool
    {
     ...
     */
    public function replicate(User|\Sharenjoy\NoahShop\Models\User $user, Carousel $carousel): bool
    {
