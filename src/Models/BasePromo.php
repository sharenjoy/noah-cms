...
use Sharenjoy\NoahCms\Tables\Columns\PromoTypeColumn;
...
class BasePromo extends Model
{
            ...
            'right' => [
                ...
                'display_expired_at' => Section::make()->schema([
                    DateTimePicker::make('display_expired_at')
                        ->displayFormat('Y-m-d H:i:s') // 顯示格式
                        ->label(__('noah-cms::noah-cms.shop.promo.title.display_expired_at'))
                        ->helperText(new HtmlString(__('noah-cms::noah-cms.shop.promo.help.display_expired_at')))
                        ->placeholder('2020-03-18 09:48:00')
                        ->prefixIcon('heroicon-o-clock')
                        ->format('Y-m-d H:i:s')
    ...
    protected function tableFields(): array
    {
        return [
            ...
            'promo_event' => PromoAutoGenerateEventColumn::make('auto_generate_type')
                ->label(__('noah-cms::noah-cms.shop.promo.title.combined') . '/' . __('noah-cms::noah-cms.shop.promo.title.auto_generate_type'))
                ->toggleable(),
    ...
    {
        return \Sharenjoy\NoahCms\Database\Factories\PromoFactory::new();
    }
    ...
    {
        return \Sharenjoy\NoahCms\Models\Promo::class; // 你想要寫入 activity_log 裡的 class 名稱
    }
