...
use Sharenjoy\NoahCms\Exceptions\Survey\GuestEntriesNotAllowedException;
use Sharenjoy\NoahCms\Exceptions\Survey\MaxEntriesPerUserLimitExceeded;
    ...
    protected function tableFields(): array
    {
        ...
        return [
            ...
            'participant' => TextColumn::make('participant')
                ->label(__('noah-cms::noah-cms.survey.title.participant'))
