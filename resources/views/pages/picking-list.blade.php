                ...
                <table style="width: 100%; margin-top: 24px; border-collapse: collapse; border: 1px solid #e2e8f0;">
                    ...
                    <tfoot>
                        <tr style="background-color: #f7fafc;">
                            ...
                            <td style="border: 1px solid #e2e8f0; padding: 3px 6px; text-align: right; font-weight: bold; color: #4a5568; font-size: 14px;">{{ number_format(\Sharenjoy\NoahCms\Actions\Shop\CalculateOrderItemTotalWeight::run($order)) }}(g)</td>
                        </tr>
                        <tr style="background-color: #f7fafc;">
