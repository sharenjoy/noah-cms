<div class="fi-ta-text grid w-full gap-y-1 px-3 py-4">
    ...
    @if ($state == \Sharenjoy\NoahCms\Enums\PromoType::Coupon)
        <div class="w-fit">
    ...
    @elseif ($state == \Sharenjoy\NoahCms\Enums\PromoType::MinSpend)
        <div class="w-fit">
            <div class="flex gap-1">
                <x-filament::badge iconSize="Large" color="danger">{{ $state->getLabel() }}</x-filament::badge>
    ...
    @elseif ($state == \Sharenjoy\NoahCms\Enums\PromoType::MinQuantity)
        <div class="w-fit">
            <div class="flex gap-1">
                <x-filament::badge iconSize="Large" color="danger">{{ $state->getLabel() }}</x-filament::badge>
    ...
    <ul class="grid gap-1">
        ...
        <li><div class="text-sm" style="color: #3a3a3a">
            <div class="flex gap-1">
                ...
                <div class="font-bold">
                    @if ($record->discount_type->value == \Sharenjoy\NoahCms\Enums\PromoDiscountType::Percent->value)
                    {{ $record->discount_percent }}%
                    @elseif ($record->discount_type->value == \Sharenjoy\NoahCms\Enums\PromoDiscountType::Amount->value)
