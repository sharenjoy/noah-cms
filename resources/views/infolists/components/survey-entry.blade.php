    ...
    <div class="w-full max-w-full overflow-x-auto">
        <ul class="divide-y divide-gray-100">
            ...
            <li class="flex py-6">
                ...
                <div class="flex-1">
                    <h3 class="text-md font-medium text-gray-700">{{ $participant->name }}</h3>
                </div>
            </li>
            ...
            <li class="flex py-6">
                ...
                <div class="flex-1">
                    <h3 class="text-md font-medium text-gray-700">{{ \Sharenjoy\NoahCms\Enums\SurveyEntryStatus::getLabelFromOption($getRecord()->status) }}</h3>
