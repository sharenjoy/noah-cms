            ...
            <li class="flex py-6">
                ...
                <div class="flex-1">
                    <ul class="grid gap-1">
                        ...
                        <li class="flex justify-start gap-1 py-1">
                            <div class="w-fit">
                                <div class="flex gap-1">
                                    @if ($shipment->provider != \Sharenjoy\NoahCms\Enums\DeliveryProvider::None)
                                    <x-filament::avatar
                        ...
                        <li>
                            <div class="text-md" style="color: #6e6e6e"> {!! \Sharenjoy\NoahCms\Actions\Shop\DisplayOrderShipmentDetail::run(shipment: $shipment) !!}</div>
                        </li>
                        ...
                        @if ($shipment->provider == \Sharenjoy\NoahCms\Enums\DeliveryProvider::Postoffice && $shipment->postoffice_delivery_code)
            ...
            <li class="flex py-6">
                ...
                <div class="flex-1">
                    <ul class="grid gap-1">
                        ...
                        @if ($transaction->payment_method == \Sharenjoy\NoahCms\Enums\PaymentMethod::ATM)
            ...
            <li class="flex py-6">
                ...
                <div class="flex-1">
                    <ul class="grid gap-1">
                        ...
                        @if ($invoice->type == \Sharenjoy\NoahCms\Enums\InvoiceType::Donate)
                            <li><div class="text-md" style="color: #6e6e6e">{!! config('noah-cms.donate_code.' . $invoice->donate_code) !!}</div></li>
                        @elseif ($invoice->type == \Sharenjoy\NoahCms\Enums\InvoiceType::Holder)
                            <li class="flex justify-start gap-1 py-1">
                        ...
                        @elseif ($invoice->type == \Sharenjoy\NoahCms\Enums\InvoiceType::Company)
